...
class SemesterHeader extends Component {
            ...
            <div className="flex flex-1 items-center justify-between p-8 sm:p-24">
                ...
                <div className="flex flex-shrink items-center sm:w-224">
                    ...
                    <div className="flex items-center">
                        ...
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Typography variant="h6" className="hidden sm:flex">Semester</Typography>
                        </FuseAnimate>
                    </div>
                </div>
                ...
                <div className="flex flex-1 items-center justify-center pr-8 sm:px-12">
                    ...
                    <MuiThemeProvider theme={mainTheme}>
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Paper className="flex p-4 items-center w-full max-w-512 px-8 py-4" elevation={2}>
...
function mapStateToProps({SemesterApp, fuse})
{
    return {
