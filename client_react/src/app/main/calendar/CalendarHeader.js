...
const styles = theme => ({
  root: {
    ...
    "&.CourseImg": {
      backgroundImage:
        "url(http://www.kpu.ca/sites/default/files/Calendar/calendar_grad.jpg)"
    },
    "&.ColorImgOverlay": {
      background: `rgba(49, 58, 70, 0.82)`,
      overflow: "hidden"
    }
  }
});
              ...
              <div className="flex items-center my-16 sm:mb-0">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <Typography variant="h6">
                    {calender.semester
                      ? calender.semester.season.charAt(0).toUpperCase() +
                        calender.semester.season.slice(1) +
                        " " +
                        calender.semester.year +
                        " - " +
                        calender.department.department_name
                      : "Calendar"}
                  </Typography>
                </FuseAnimate>
              </div>
...
export default withStyles(styles, { withTheme: true })(
  connect(mapStateToProps)(CalendarHeader)
);
>>>>>>> Ferdi
