...
import CalendarsTableHead from './CalendarsTableHead';
...
{
    return {
        products  : CalendarsApp.calendars.data,
        searchText: CalendarsApp.calendars.searchText
    }
}

export default withRouter(connect(mapStateToProps, null)(ProductsTable));
