...
class BuildingHeader extends Component {
          ...
          <div className="flex flex-1 w-full items-center justify-between p-8 sm:p-24">
              ...
              <div className="flex flex-shrink items-center sm:w-224">
                  ...
                  <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                      <Typography className="hidden sm:flex" variant="h6">Building</Typography>
                  </FuseAnimate>
              </div>
...
function mapStateToProps({BuildingApp, fuse})
{
    return {
...
export default connect(mapStateToProps, mapDispatchToProps)(BuildingHeader);
